...
const GetRoadmap = ({ styles }) => (
  <button
    type="button"
    className={`flex flex-row items-center py-4 px-6 font-poppins font-medium text-[18px] text-primary bg-blue-gradient rounded-[10px] outline-none ${styles} rounded-[10px]`}
    onClick={() =>
      window.open(
